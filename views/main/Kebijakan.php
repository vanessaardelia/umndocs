...
$this->title = 'Dokumen Kebijakan';

$kebijakan = new ActiveDataProvider([
...
//    $dataProvider = $searchModel->search(Yii::$app->request->queryParams),
    ...
    'query' => Document::find() ->select(['JenisDoc', 'DocumentStatus', 'CreatedBy', 'M_Revisi.NamaDoc AS namaDoc'])
                                ...
                                ->where('M_Document.JenisDoc = "Kebijakan"'),
...
<div class="site-index">
    <div class="body-content container-fluid">
        <h2 class="text-bold">Dokumen Kebijakan</h2>
        <hr>

        <?= GridView::widget([
            'dataProvider' => $kebijakan,
